...
reCAPTCHA is available with [Dynamic Form Maker Pro](http://dfmpro.com).
...
If your forms do not look as expected, chances are there's some CSS in your theme conflicting with the built-in CSS of Dynamic Form Maker. Please follow the tutorial on [how to customize the CSS](http://matthewmuro.com/2012/11/15/dynamic-form-maker-pro-customizing-the-form-design/).
...
If, after following the above procedures, you are still having problems please report this issue on the [Support Forum](http://wordpress.org/support/plugin/dynamic-form-maker).

= Customizing the form design =

Please follow the tutorial on [how to customize the CSS](http://matthewmuro.com/2012/11/15/dynamic-form-maker-pro-customizing-the-form-design/).

By upgrading to Dynamic Form Maker Pro, you be able to purchase the [Form Designer](http://dfmpro.com/add-ons/form-designer) add-on which will let you easily customize the design.
...
The recommended method to translate the messages is by installing the free [Custom Validation Messages](http://wordpress.org/extend/plugins/dfm-custom-validation-messages/) add-on.  This will let you easily change the messages for all forms from within the WordPress admin.
...
* Add dfm_spam_words_exploits, dfm_spam_words_profanity, and dfm_spam_words_misc filters to allow spam sensitivity words to be controlled
...
* Update errorClass to more specific dfm-error class name
...
* Add dfm_sender_mail_header, dfm_show_version filters
* Add an ID attribute to the form container div
* Update CSS enqueue to only load when form exists on the page
* Update list of user agent strings to test against in dfm_blocked_spam_bots
...
* Add dfm_address_labels_placement, dfm_skip_referrer_check filters
...
* Update dfm_address_labels filter to allow control over Address field
...
= 2.1 =
Please note this version requires WordPress 3.3.  Please update your WordPress install before upgrading to Dynamic Form Maker 2.1.
