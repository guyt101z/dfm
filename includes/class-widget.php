...
add_action( 'widgets_init', 'dfm_register_widgets' );

function dfm_register_widgets() {
	register_widget( 'DynamicFormMaker_Widget' );
}
...
class DynamicFormMaker_Widget extends WP_Widget {
	...
	public function __construct(){
		...
		$args = array(
			...
			'description' 	=> 'Dynamic Form Maker widget'
		);

		$this->WP_Widget( 'dfm_widget', 'Dynamic Form Maker', $args );
	}
	...
	public function form( $instance ) {
		...
		$where = apply_filters( 'dfm_pre_get_forms_widget', '' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'id' ); ?>"><?php _e( 'Form to display:', 'dynamic-form-maker' ); ?></label>
	...
	public function widget( $args, $instance ) {
		...
		// Print the output
		echo do_shortcode( "[dfm id=$form_id]" );
